...
import { FaAward, FaUsers, FaSchool } from "react-icons/fa";
        ...
        <div className="about__content">
          <div className="about__cards">
            <article className="about__card">
              <FaSchool size={40} className="about__icon" />
              <h5>McMaster University</h5>
            </article>
            <article className="about__card">
              <FaUsers size={40} className="about__icon" />
              <h3>3rd Year</h3>
            </article>
            <article className="about__card">
              <FaAward size={40} className="about__icon" />
              <h3>3.7 GPA</h3>
            </article>
          </div>
          <p>
